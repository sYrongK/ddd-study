...
import static com.syrongk.ddd.config.security.WebSecurityConfig.AUTHCOOKIENAME;
...
public class CookieSecurityContextRepository implements SecurityContextRepository {
    ...
    public CookieSecurityContextRepository(UserDetailsManager userDetailsManager) {
